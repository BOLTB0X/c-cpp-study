...
- [캡슐화 (Encapsulation)](https://github.com/BOLTB0X/c-cpp-study/tree/main/cpp/CLasss02#캡슐화-encapsulation)

   데이터와 함수를 하나의 클래스 안에 묶음(`private` , `public` , ..)

   ---

- [추상화 (Abstraction)](https://github.com/BOLTB0X/c-cpp-study/tree/main/cpp/CLasss02#추상화-abstration)

   불필요한 정보는 숨기고 핵심 기능만 노출(`abstract class`, 인터페이스)

   ---

- [상속 (Inheritance)](https://github.com/BOLTB0X/c-cpp-study/tree/main/cpp/CLasss02#상속-inheritance)

   기존 클래스를 확장하여 새로운 클래스를 정의(`class B : public A`)

   ---

- [다형성 (Polymorphism)](https://github.com/BOLTB0X/c-cpp-study/tree/main/cpp/CLasss02#다형성-polymorphism)

   하나의 인터페이스로 다양한 동작 가능(`virtual` , 오버라이딩)
...
- `protected`
   ...
   - 자식 클래스의 확장성을 위해 열어 둠

   ---

- **default** 

   - 지정자는 `class`, `struct` 에 따라 다르기 때문에 명시적으로 작성하는 것이 권장됨
